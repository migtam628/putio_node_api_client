...
})(exports.PutioAPIClientEventTypes || (exports.PutioAPIClientEventTypes = {}));
...
var createClientIPChangeEmitterMiddleware = function (client) {
    ...
    var checkIP = function (response) {
        ...
        if (newIP && IP !== newIP) {
            client.emit(exports.PutioAPIClientEventTypes.CLIENT_IP_CHANGED, { IP: IP, newIP: newIP });
            IP = newIP;
            return;
        }
    };
...
var createErrorEmitterMiddleware = function (client) { return ({
    ...
    onRejected: function (error) {
        client.emit(exports.PutioAPIClientEventTypes.ERROR, error);
        return Promise.reject(error);
    },
}); };
...
var PutioAPIClient = /** @class */ (function () {
    ...
    PutioAPIClient.EVENTS = exports.PutioAPIClientEventTypes;
...
exports.MockPutioAPIClient = MockPutioAPIClient;
